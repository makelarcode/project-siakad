...
var EduZone = function () {
    ...
    var homeSearch = function () {
        ...
        quikSearch.on('click', function () {
            jQuery('.rdx-quik-search').animate({
                'width': '100%'
            });
            jQuery('.rdx-quik-search').delay(500).css({
                'left': '0'
            });
        });
    ...
    var handleSupport = function () {
        ...
        var support = '<script type="text/javascript"></script><a href=""><span></span></a>';
